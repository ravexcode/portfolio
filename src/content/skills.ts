export const skills = [
  {
    name: "JavaScript",
    img: "https://cdn.iconscout.com/icon/free/png-256/free-javascript-logo-icon-svg-download-png-2284965.png?f=webp&w=128"
  },
  {
    name: "TypeScript",
  ...
  {
    name: "Express JS",
    img: "https://expressjs.com/favicon.ico",
    isFramework: true
  },
  {
    name: "NextJS",
  ...
  {
    name: "Astro",
    img: "https://astro.build/favicon.svg",
    isFramework: true
  },
  {
    name: "Flutter",
  ...
  {
    name: "NeonSQL",
    img: "https://neon.com/favicon/favicon.svg",
    isApplication: true
  },
  {
    name: "Vercel",
